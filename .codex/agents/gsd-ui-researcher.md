...
Use template from `D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

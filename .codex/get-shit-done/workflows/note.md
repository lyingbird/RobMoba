...
- **Global scope**: `D:/工作/Roblox联动/roblox_vibecoding/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/工作/Roblox联动/roblox_vibecoding/.codex/notes/`)
...
2. Glob `D:/工作/Roblox联动/roblox_vibecoding/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/工作/Roblox联动/roblox_vibecoding/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/工作/Roblox联动/roblox_vibecoding/.codex/notes/` — works in any directory

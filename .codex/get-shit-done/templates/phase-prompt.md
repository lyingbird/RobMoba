...
<!-- For checkpoint task examples and patterns, see @D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/references/checkpoints.md -->
...
See `D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.

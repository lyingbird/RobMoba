...
- Usage: Reference from command with `@D:/工作/Roblox联动/roblox_vibecoding/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/工作/Roblox联动/roblox_vibecoding/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/工作/Roblox联动/roblox_vibecoding/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

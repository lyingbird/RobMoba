...
| 常量 | 值 | 来源 | 含义 |
|---|---|---|---|
| `POS_PRESS_TIME_THRESHOLD` | 1.0 秒 | `IsAllowUseSkill` 硬编码 1000ms | Pos 型按压时间阈值 |
| `DIR_QUICK_TAP_THRESHOLD` | 0.4 秒 | `OnSkillButtonUp` 硬编码 400ms | Directional 快速点击阈值 |

...
-- 1. 技能范围指定类型
--------------------------------------------------------------------------------
-- 原始枚举有7种，Roblox 精简: 保留5种（去掉 Project8Directional / Project8Pos）
--
...
SkillEnums.SkillRangeType = {
    ...
    Track       = 4,  -- 指定轨迹，拖动绘制路径（已废弃但保留枚举）
}

--------------------------------------------------------------------------------
-- 2. 技能槽位
--------------------------------------------------------------------------------
-- 原始设计使用 0-7 共8个槽位，Roblox 精简为6个
...
-- 6. 取消模式
--------------------------------------------------------------------------------
-- 原始设计有3种: AreaCancle / DisitanceCancle / Unity3DTouchCancle

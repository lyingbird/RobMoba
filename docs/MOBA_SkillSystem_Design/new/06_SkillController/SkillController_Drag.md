...
> **HOK 来源**: `SkillBtnController.OnSkillButtonDrag()` 第590-723行  
...
```lua
-- 来源: HOK SkillBtnController.OnSkillButtonDrag() 第590-723行
-- 精简说明:
--   HOK 原版还有: 蓄力角度更新、锁定框目标切换、JoystickMode 特殊处理、MoveSkillCursorInScene
...
- 硬编码 120 像素
- HOK 中这个值由 JoystickMode 和按钮配置决定

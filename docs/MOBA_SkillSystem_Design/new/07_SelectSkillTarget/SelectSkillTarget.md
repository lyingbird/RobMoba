...
> **HOK 来源**: `SkillControlIndicator.SelectSkillTarget()` 第3563-3775行
...
```lua
-- 来源: HOK SkillControlIndicator.SelectSkillTarget() 第3563-3575行
...
> HOK 来源: `SelectSkillTarget()` 第3583-3634行
...
--
-- HOK 原文分界线: offset.magnitude <= guideDistance * 0.5f
...
> HOK 来源: `SelectSkillTarget()` 第3636-3706行
...
--
-- HOK 原文: bMoveFlag = true; bControlMove = true
...
> HOK 来源: `SelectSkillTarget()` 第3708-3740行
...
--
-- 方向插值:
--   HOK 有4种旋转插值模式 (RotateLerpMode 0/1/2/3)
...
> **注意**: HOK 中此类型**已完全废弃/未实现**。枚举值 `Track=4` 保留但无实际逻辑。以下为合理推断设计。
...
--
-- 来源: HOK Camera.ScreenPointToRay 适配
